...
### **This step is no longer required after (nightly releases) after 19/02/2026 as this was fixed in core yt-dlp**. This section will be removed once it is moved into a release version.
